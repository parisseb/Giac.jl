...
## Installation
Giac/Xcas has to be [installed](https://www-fourier.univ-grenoble-alpes.fr/~parisse/install_en#linux) first, if you install Xcas packages from your Linux distributions, install the devel package (for example `libgiac-dev` in Debian/Ubuntu). 
